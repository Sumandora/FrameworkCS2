...
namespace GameHook {
	void hook()
	{
		FrameStageNotify::hook = new GameHook(BCRL::Session::pointerArray(Interfaces::source2Client, 33).expect("Couldn't find FrameStageNotify"), reinterpret_cast<void*>(FrameStageNotify::hookFunc));
